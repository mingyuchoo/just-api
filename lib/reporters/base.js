...
export default class BaseReporter {
  ...
  printSummary() {
    ...
    console.log();
    console.log(
      chalk.cyan(`${skippedTestsCount} skipped, `) +
        chalk.red(`${failedTestsCount} failed, `) +
        chalk.green(`${passedTestsCount} passed `) +
        `(${totalTestsCount} tests)`
    );
    console.log(
      chalk.cyan(`${skippedSuitesCount} skipped, `) +
        chalk.red(`${failedSuitesCount} failed, `) +
        chalk.green(`${passedSuitesCount} passed `) +
        `(${this.plannedSuites.length} suites)`
    );
