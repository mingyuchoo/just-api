    ...
    <body>
        <div id="just-api">
            <div class="just-api-top-header">
                ...
                <span>${data.stats.skippedTests} Skipped, ${data.stats.failedTests} Failed, ${
    data.stats.passedTests
  } Passed ( ${data.stats.tests} Tests )</span>
                <br>
                <span>${data.stats.skippedSuites} Skipped, ${data.stats.failedSuites} Failed, ${
    data.stats.passedSuites
  } Passed ( ${data.stats.suites} Suites )</span>
                <br>
